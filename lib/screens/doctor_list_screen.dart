...
class _DoctorListScreenState extends State<DoctorListScreen> {
  ...
  void _viewDoctorProfile(DoctorRecommendation doctor) {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => DoctorProfileScreen(doctorId: doctor.doctorId)));
  }

  void _bookAppointment(DoctorRecommendation doctor) {
    // Navigate to appointment booking screen
    Navigator.push(context, MaterialPageRoute(builder: (context) => AppointmentBookingScreen( selectedDiseases: widget.selectedDiseases)));
  }
}